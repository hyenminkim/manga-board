...
//    }
    ...
    // SecurityFilterChain 을 Bean 으로 등록하여 설정
    @Bean
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/board/write/**", "/board/update/**", "/board/delete/**","/mypage/**").hasAnyRole("MEMBER", "ADMIN")
                ...
                .formLogin(form -> form
                        ...
                        .successHandler(new CustomLoginSuccessHandler("/managa/list"))
